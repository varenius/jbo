...
#**** note added k-band to old vex2em5.py ****    
...
def makeConfig(vex, tels, nstreams,doubleSB=False):
    ...
    elif frequ > 2000.0 and frequ < 8000.0:#C-band
        obs = "oldfreq = ObservingFrequency.find('C-Band_5GHz') # ObservingFrequency 4816.0e+06 C-band \n"
    elif frequ > 18000.0:
        obs = "oldfreq = ObservingFrequency.find('K22000') # ObservingFrequency 22000.0e+06 K-band \n"
