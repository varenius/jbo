...
#			      - Minor fixes.
# varenius     04/12/2019     - Changed default output directory to current working directory instead of script directory.
#----------------------------------------------------------------------------------------------------------------------------------------------------------
...
def main(args):
	...
	antabFile = os.getcwd() + ('/%s.antabfs' % (logFileName.split('/')[-1].split('.')[0]))
